...
def COHORT():
    ...
    ## x = InitRecog.COHORT().copy()
    ## x.index = InitRecog.COHORT()
...
#     cellStr = "'"+cell+"'"
#     try:
#         temp = [eval(f"Input.Actuals.Cashflows.{cohort}[{cellStr}][{args[0][0]}]") for cohort in COHORTS]
#     except KeyError:
#         temp = [0 for cohort in COHORTS]
#     return Input.pd.Series(temp, index = COHORTS)
# =============================================================================
